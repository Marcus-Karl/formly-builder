...
export class FormlyFormBuilderPreviewComponent implements OnDestroy, OnInit {
  ...
  constructor(private formlyJsonschema: FormlyJsonschema, private formlyBuilder: FormlyFormBuilder, private translateService: TranslateService) {
    ...
    let field = derivedForm(); // getFieldValues();
  ...
  "widget": {
    "formlyConfig": {
      ...
      "templateOptions": {
        ...
        "linear": false,
        "labelPosition": "end",
        "_translationFormKey": "k8328ceaf4dd94c5d87f7c137b0124702"
      }
    }
  },
  "properties": {
    "c18df3776db84b1ca9c1cd5951b76ce6": {
      "type": "object",
      "title": "Welcome Page",
      "widget": {
        "formlyConfig": {
      ...
      "properties": {
        "l7846782253c949fcbb3035a273371db0": {
          "type": "null",
          "title": "Display Field",
          "widget": {
            "formlyConfig": {
              ...
              "templateOptions": {
                "_order": "1",
                "html": "<h1 style=\"text-align:center\"><strong>Welcome to the Form Creator</strong></h1><p>Please add as many pages and fields as you would like.</p>"
              }
            }
          }
        }
    ...
    "p9067bba8936d4075bcb23f63fa333ee3": {
      "type": "object",
      "title": "About You",
      "widget": {
        "formlyConfig": {
      ...
      "properties": {
        "g11b149552537437684aa5c02d8a1d107": {
          "type": "string",
        ...
        "n283e6d579d224a1392fa26009ed15f19": {
          "type": "string",
        ...
        "q7b3dfa6a31654c9d83021e971200a94c": {
          "type": "string",
